  ...
  return (
    <div className="space-y-8 py-8">
      <div className="space-y-3">
        <h1 className="text-5xl font-bold text-slate-900 dark:text-slate-50">Health & Wellness Universe</h1>
        <p className="text-xl text-slate-600 dark:text-slate-300 max-w-2xl">
          Vitals, activities, nutrition, sleep, and holistic wellness intelligence.
        </p>
      </div>
      ...
      <Card className="space-y-4">
        <h2 className="text-xl font-bold text-slate-900 dark:text-slate-50">Today's Nutrition</h2>
        <div className="space-y-3">
          {nutrition.map((entry) => (
