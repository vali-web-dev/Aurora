  ...
  'inline-flex items-center justify-center rounded-lg font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-slate-200 text-slate-900 hover:bg-slate-300 focus-visible:ring-slate-600',
        accent: 'bg-red-500 text-white hover:bg-red-600 focus-visible:ring-red-500',
        outline: 'border-2 border-slate-300 text-slate-900 hover:bg-slate-50 focus-visible:ring-slate-600',
