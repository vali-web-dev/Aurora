  ...
  return (
    <div className={clsx('flex flex-col gap-3 md:flex-row md:items-end md:justify-between', className)}>
      <div className="space-y-2">
        ...
        {description && (
          <p className="aurora-label text-base text-slate-600 dark:text-slate-400 max-w-2xl">
            {description}
          </p>
        )}
      </div>
    ...
    <section className={clsx('space-y-4', className)}>
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div className="space-y-1">
          <h2 className="aurora-label text-base sm:text-lg font-semibold text-slate-900 dark:text-slate-50">
            {title}
          </h2>
          {description && (
            <p className="aurora-label text-sm text-slate-600 dark:text-slate-400 max-w-2xl">
              {description}
            </p>
          )}
        </div>
