...
export function getPageIconColor(pageName: string): string {
  const colorMap: Record<string, string> = {
    ...
    Brand: 'text-fuchsia-500',
    Communities: 'text-indigo-500',
