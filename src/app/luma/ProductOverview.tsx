export function ProductOverview() {
    return (
        <section className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 text-xs" role="list" aria-label="Product overview highlights">
                <div className="rounded-2xl border border-aurora-border/70 bg-aurora-surface/60 p-4" role="listitem">
